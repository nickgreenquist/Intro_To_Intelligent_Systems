...
# Usage: statToRoundedCsv.py resultDirectory outputFile type
# resultDirectory: directory of files in stat format
# outputFile: file to store CSV file format with rounded numbers
...
USAGE_MESSAGE = "Usage: statToRoundedCsv.py resultDirectory outputFile type"
...
def processFile(fileName: str, type: str) -> (str, float):
	...
	score = round(float(scoreLine) * 100, 1)
